...
public class ParameterCheckHandler {
     ...
     * @throws Exception
     */
    public static void checkFiled(Object object, Annotation annotation, String timing) throws Exception {
        if (object == null) {
            throw new ParameterException(ExceptionCodeMsg.NULL);
        }
        //get all the object's filed
     ...
     * @throws Exception
     */
    public static void checkFileds(Object object, Annotation annotation, String timing, Field... fields) throws Exception {
     ...
     * @throws Exception
     */
    private static void checkForAnnotations(Object object, Annotation annotation, String timing, Field... fields) throws Exception {
        if (object == null) {
            throw new ParameterException(ExceptionCodeMsg.NULL);
        }
